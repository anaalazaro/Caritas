...
#  path('controlar_intercambio/<int:intercambio_id>', controlar_intercambio, name='controlar_intercambio'),
 path('listaIntercambiosSolicitantes/', viewsInicio.mostrarSolictudesIntercambios, name='lista_intercambios_solicitantes'),
 path('listaIntercambiosPropuestos/', viewsInicio.mostrarIntercambiosPropuestos, name='lista_intercambios_propuestos'),
